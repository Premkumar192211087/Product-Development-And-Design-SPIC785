...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2025 at 07:46 AM
...
INSERT INTO `products` (`id`, `store_id`, `product_name`, `quantity`, `price`, `cost_price`, `created_at`, `category`, `sku`, `image_url`, `status`) VALUES
(1, 1, 'iPhone 15 Pro', 9, 999.99, 600.00, '2025-06-09 05:23:54', 'Mobile Devices', 'IPH15PRO001', 'https://example.com/iphone15pro.jpg', 'active'),
(2, 1, 'Samsung Galaxy S24', 20, 899.99, 500.00, '2025-06-09 05:23:54', 'Mobile Devices', 'SAM24001', 'https://example.com/galaxys24.jpg', 'active'),
(3, 1, 'MacBook Air M3', 15, 1299.99, 1000.00, '2025-06-09 05:23:54', 'Computers', 'MBA2024001', 'https://example.com/macbookair.jpg', 'active'),
(4, 1, 'Dell XPS 13', 12, 1099.99, 900.00, '2025-06-09 05:23:54', 'Computers', 'DELL13001', 'https://example.com/dellxps13.jpg', 'active'),
(5, 1, 'Sony WH-1000XM5', 30, 399.99, 200.00, '2025-06-09 05:23:54', 'Audio', 'SONY1000XM5', 'https://example.com/sonywh1000xm5.jpg', 'active'),
(6, 1, 'PlayStation 5', 8, 499.99, 400.00, '2025-06-09 05:23:54', 'Gaming', 'PS5CONSOLE', 'https://example.com/ps5.jpg', 'active'),
(7, 1, 'Nintendo Switch OLED', 18, 349.99, 300.00, '2025-06-09 05:23:54', 'Gaming', 'NSWITCHOLED', 'https://example.com/switcholed.jpg', 'active'),
(8, 1, 'USB-C Cable 6ft', 100, 19.99, 5.00, '2025-06-09 05:23:54', 'Cables', 'USBCABLE6FT', 'https://example.com/usbccable.jpg', 'active'),
(9, 1, 'iPhone 15 Case', 50, 29.99, 10.00, '2025-06-09 05:23:54', 'Cases', 'IPH15CASE', 'https://example.com/iphone15case.jpg', 'active'),
(10, 1, 'Wireless Charger Pad', 35, 49.99, 15.00, '2025-06-09 05:23:54', 'Chargers', 'WRLSCHARGER', 'https://example.com/wirelesscharger.jpg', 'active');
...
INSERT INTO `returns` (`return_id`, `return_number`, `sale_id`, `customer_id`, `store_id`, `return_date`, `return_amount`, `total_refund_amount`, `return_reason`, `processed_by`, `status`, `notes`) VALUES
(1, 'RET-2024-001', 2, 2, 1, '2025-06-09 05:32:00', 50.00, 410.39, 'Defective product - headphones not working properly', 2, 'processed', 'Full refund issued'),
(2, 'RET-2024-002', 4, 4, 1, '2025-06-09 05:32:00', 30.00, 29.99, 'Customer changed mind about phone case', 3, 'processed', 'Partial return - case only'),
(3, 'RET-2024-003', 8, 8, 1, '2025-06-09 05:32:00', 0.00, 19.99, 'Wrong cable type ordered', 4, 'processed', 'Exchange for correct cable'),
(4, 'RET-2024-004', 10, 10, 1, '2025-06-09 05:32:00', 0.00, 49.99, 'Wireless charger compatibility issue', 2, 'pending', 'Under review'),
(5, 'RET-2024-005', 6, 6, 1, '2025-06-09 05:32:00', 0.00, 377.99, 'Console arrived damaged', 2, 'processed', 'Full refund for damaged Switch'),
(6, 'RET-2024-006', 1, 1, 1, '2025-06-09 05:32:00', 0.00, 0.00, 'Screen protector request', 3, 'cancelled', 'Customer kept original purchase'),
(7, 'RET-2024-007', 9, 9, 1, '2025-06-09 05:32:00', 0.00, 0.00, 'Inquiry about warranty', 4, 'cancelled', 'No return needed - warranty info provided'),
(8, 'RET-2024-008', 5, 5, 1, '2025-06-09 05:32:00', 0.00, 0.00, 'Controller compatibility question', 2, 'cancelled', 'Compatible - no return');
...
ALTER TABLE `user_devices`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `user_id` (`user_id`,`fcm_token`);
